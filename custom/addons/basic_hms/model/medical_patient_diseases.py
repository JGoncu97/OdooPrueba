...
class medical_patient_diseases(models.Model):
    ...
    is_infectious = fields.Boolean(string='Enfermedad infecciosa', help='Marque si el paciente tiene una enfermedad infecciosa/transmisible')
    short_comment = fields.Char(string='Observaciones')
    healed_date = fields.Date(string='Fecha de curación')
    physician_id = fields.Many2one('medical.patient', string='Médico')
    ...
    weeks_of_pregnancy = fields.Integer(string='Contraída en la semana de embarazo #')
    ...
    psc_code_id = fields.Many2one('psc.code', string='Código')
